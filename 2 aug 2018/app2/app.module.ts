...
import { StudentDetailComponent } from './student-detatil.component';
...
@NgModule({
    ...
    StudentListComponent,StudentDeleteComponent,StudentDetailComponent,ReversePipe,MyCurrencyPipe],
